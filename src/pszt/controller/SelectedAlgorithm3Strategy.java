 ...
 *
 */
class SelectedAlgorithm3Strategy extends Strategy
{
	private Model model;
	private View view;
	/**
	 * 
	 */
	public SelectedAlgorithm3Strategy(final Model model, final View view)
	{
		this.model = model;
		this.view = view;
	}
	...
	{
		view.setResult(model.runAlgorithm3(model.getKnowledgeBase()));
	}
